...
fn run(listing: &str) -> SimulationResult {
    ...
    sim86.write_8_to_memory(4, &source);
    sim86.write_16(IP_REG_IDX, &(4 as u16));
    sim86.write_8_to_memory(0, &((source.len() + 4) as u32).to_be_bytes());
    
    let mut transitions = Vec::new();
    let inst_end: u16 = (source.len() + 4) as u16;
